...
var ReactPasswordChecklist = function(_a) {
  ...
  var _c = (0, import_react2.useState)(false), isValid = _c[0], setIsValid = _c[1];
  var ruleDefinitions = {
    minLength: {
  ...
  var enabledRules = rules.filter(function(rule) {
    return Boolean(ruleDefinitions[rule]);
  });
  (0, import_react2.useEffect)(function() {
    if (enabledRules.every(function(rule) {
  ...
  return import_react2.default.createElement(UL, { className, style }, enabledRules.map(function(rule) {
    var _a2 = ruleDefinitions[rule], message = _a2.message, valid = _a2.valid;
    return import_react2.default.createElement(Rule, __assign({ key: rule, valid, iconSize: 18, validColor: "#4BCA81", invalidColor: "#FF0033" }, remainingProps), message);
  }));
};
var Rule = function(_a) {
  ...
  return import_react2.default.createElement(
    ...
    iconComponents ? valid ? iconComponents.ValidIcon : iconComponents.InvalidIcon : import_react2.default.createElement(
      Svg,
      { className: "checklist-icon", version: "1.1", xmlns: "http://www.w3.org/2000/svg", width: iconSize, height: iconSize, viewBox: "0 0 512 512" },
      import_react2.default.createElement("path", { fill: valid ? validColor : invalidColor, d: valid ? "M432 64l-240 240-112-112-80 80 192 192 320-320z" : "M507.331 411.33c-0.002-0.002-0.004-0.004-0.006-0.005l-155.322-155.325 155.322-155.325c0.002-0.002 0.004-0.003 0.006-0.005 1.672-1.673 2.881-3.627 3.656-5.708 2.123-5.688 0.912-12.341-3.662-16.915l-73.373-73.373c-4.574-4.573-11.225-5.783-16.914-3.66-2.080 0.775-4.035 1.984-5.709 3.655 0 0.002-0.002 0.003-0.004 0.005l-155.324 155.326-155.324-155.325c-0.002-0.002-0.003-0.003-0.005-0.005-1.673-1.671-3.627-2.88-5.707-3.655-5.69-2.124-12.341-0.913-16.915 3.66l-73.374 73.374c-4.574 4.574-5.784 11.226-3.661 16.914 0.776 2.080 1.985 4.036 3.656 5.708 0.002 0.001 0.003 0.003 0.005 0.005l155.325 155.324-155.325 155.326c-0.001 0.002-0.003 0.003-0.004 0.005-1.671 1.673-2.88 3.627-3.657 5.707-2.124 5.688-0.913 12.341 3.661 16.915l73.374 73.373c4.575 4.574 11.226 5.784 16.915 3.661 2.080-0.776 4.035-1.985 5.708-3.656 0.001-0.002 0.003-0.003 0.005-0.005l155.324-155.325 155.324 155.325c0.002 0.001 0.004 0.003 0.006 0.004 1.674 1.672 3.627 2.881 5.707 3.657 5.689 2.123 12.342 0.913 16.914-3.661l73.373-73.374c4.574-4.574 5.785-11.227 3.662-16.915-0.776-2.080-1.985-4.034-3.657-5.707z" })
    ),
    import_react2.default.createElement("span", null, children)
  );
};
var UL = styled_components_browser_esm_default.ul(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n	margin: 0;\n	padding: 0;\n	&.rtl svg {\n		margin-left: 5px;\n		margin-right: 0;\n	}\n"], ["\n	margin: 0;\n	padding: 0;\n	&.rtl svg {\n		margin-left: 5px;\n		margin-right: 0;\n	}\n"])));
var LI = styled_components_browser_esm_default.li(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n	list-style-type: none;\n	display: flex;\n	align-items: flex-start;\n	margin: 2px 0;\n	& > span {\n		padding-top: 2px;\n		opacity: ", ";\n		flex: 1;\n	}\n"], ["\n	list-style-type: none;\n	display: flex;\n	align-items: flex-start;\n	margin: 2px 0;\n	& > span {\n		padding-top: 2px;\n		opacity: ", ";\n		flex: 1;\n	}\n"])), function(props) {
  return props.className === "valid" ? 1 : 0.5;
});
var Svg = styled_components_browser_esm_default.svg(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n	margin-right: 5px;\n"], ["\n	margin-right: 5px;\n"])));
