        ...
        <Page>
            <div className='container flex flex-col md:flex-row rounded-xl '>
                <div className='w-full md:w-1/2 relative shadow-xl rounded-xl'>
                    <img
                        className='w-full md:h-full object-cover rounded-t-xl md:rounded-l-xl'
                        src={service.image}
                        alt={service.name}
                    />
                </div>
                <div className='w-full bg-white container flex flex-col rounded-b-xl md:rounded-r-xl items-center py-5 px-2 mx-auto  md:flex-row shadow-xl bg-base-100'>
