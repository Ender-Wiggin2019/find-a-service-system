export const UkCities = {
    ...
    Kilbirnie: 'North Ayshire',
    Killin: 'Perthshire',
    Killingholme: 'Lincolnshire',
    Kilmacolm: 'Renfrewshire',
    Kilmarnock: 'North Ayshire',
    "King's Lynn": 'Norfolk',
