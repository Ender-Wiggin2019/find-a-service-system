            ...
            <div className='flex'>
                ...
                <div className='card-body w-3/4 flex flex-col justify-between p-4 cursor-pointer'>
                    ...
                    <div className='card-actions justify-end'>
                        ...
                        {/*</div>*/}
                        <Button variant='contained' className='bg-button' endIcon={showRequestList ? <ArrowDropUpIcon /> : <ArrowDropDownIcon />} onClick={handleViewRequestsClick}>
                            View Requests
                        </Button>
                    </div>
                </div>
                ...
                {showRequestList && (<div className='mt-1 w-full bg-card shadow-xl rounded-md'><RequestList serviceId={service.id}/></div>)}
        </div>
    )
}
