        ...
        const fetchUserNotifications = async () => {
            ...
            try {
                ...
                if (statusFilter.length > 0) {
                    q = query(notificationsCollection, where('status', 'in', statusFilter), orderBy('time', 'desc'))
                }
...
export const updateMessageStatus = async (userId: string, messageObj: IMessage, newStatus: MessageStatus) => {
    try {
